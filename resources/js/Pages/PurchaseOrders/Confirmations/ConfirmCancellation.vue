...
<template>
    <div class="flex flex-col space-y-6">
        <p class="dark:text-gray-300">You are about to cancel order #{{ data.reference_number }}. This will lock the record to prevent further modifications. Please double check the records before proceeding.</p>
